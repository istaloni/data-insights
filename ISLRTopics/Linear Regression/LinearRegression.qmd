...
The least squares lines and the population regression line are different but close, just like the sample mean will be different from the population mean, but it will provide a good estimate. This estimation is *unbiased*, meaning that we expect sample mean to be close to population mean if we increase the number of observations. An *unbiased estimator* does not systematically over or under estimate the true parameter. 
