...
$$
where $\sigma$ is the standard deviation of each of the $Y_i$ of $Y^2$. It tells us the average amount the $\hat{\mu}$ differs from the actual $\mu$, and that as you increase $n$ the lower the standard error. 
