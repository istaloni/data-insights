...
In a mathematical equation, it looks something like this:
$$Y = f(X) + \epsilon$$
Here, $f$ is a fixed function of inputs, and $\epsilon$ is a random error term, independent of the inputs. Overall, the errors have approximately a mean of zero. 
